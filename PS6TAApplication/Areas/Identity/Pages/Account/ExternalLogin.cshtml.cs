/*
  ...
  File Contents
    ...
    Allows login with Google, still requires that a uID is given.
*/
...
namespace PS6TAApplication.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [RegularExpression("^u[0-9]{7}", ErrorMessage = "uID must match form uXXXXXXX")]
            [Display(Name = "uID")]
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                if (info.Principal.HasClaim(c => c.Type == ClaimTypes.Email))
                {
                    ...
                    {
                        Input.ReferredTo = info.Principal.FindFirstValue(ClaimTypes.GivenName);
                    }
                }
                return Page();
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var defaultRole = _roleManager.FindByNameAsync("Applicant").Result;
                    if (defaultRole != null)
                    {
